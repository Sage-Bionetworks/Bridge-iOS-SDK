...
- (void)testBridgeJSONFromObjectNoMapping {
  ...
  XCTAssert([json[@"charField"] charValue] == object.charField, @"Correctly converted char field");
  XCTAssert([json[@"intField"] intValue] == object.intField, @"Correctly converted int field");
  XCTAssert([json[@"shortField"] shortValue] == object.shortField, @"Correctly converted short field");
  XCTAssert([json[@"longField"] longValue] == object.longField, @"Correctly converted long field");
  XCTAssert([json[@"longLongField"] longLongValue] == object.longLongField, @"Correctly converted long long field");
  XCTAssert([json[@"uCharField"] unsignedCharValue] == object.uCharField, @"Correctly converted unsigned char field");
  XCTAssert([json[@"uIntField"] unsignedIntValue] == object.uIntField, @"Correctly converted unsigned int field");
  XCTAssert([json[@"uShortField"] unsignedShortValue] == object.uShortField, @"Correctly converted unsigned short field");
  XCTAssert([json[@"uLongField"] unsignedLongValue] == object.uLongField, @"Correctly converted unsigned long field");
  XCTAssert([json[@"uLongLongField"] unsignedLongLongValue] == object.uLongLongField, @"Correctly converted unsigned long long field");
  XCTAssert([json[@"floatField"] floatValue] == object.floatField, @"Correctly converted float field");
  XCTAssert([json[@"doubleField"] doubleValue] == object.doubleField, @"Correctly converted double field");
