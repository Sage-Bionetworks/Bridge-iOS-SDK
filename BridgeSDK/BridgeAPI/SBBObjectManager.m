...
- (NSDictionary *)propertyNamesAndGettersInClass:(Class)objectClass
{
  NSMutableDictionary *namesAndGetters = [NSMutableDictionary dictionary];
  while (objectClass != [ModelObject class]) {
    [self addPropertyNamesAndGettersInClass:objectClass toDictionary:namesAndGetters];
...
- (void)addPropertyNamesAndGettersInClass:(Class)objectClass toDictionary:(NSMutableDictionary *)namesAndGetters
{
...
- (id)bridgeJSONFromObject:(id)object
{
  ...
  if ([objectClass isSubclassOfClass:[NSArray class]]) {
    ...
    if (mappings) {
      ...
      NSDictionary *namesAndGetters = [self propertyNamesAndGettersInClass:internalClassForType];
