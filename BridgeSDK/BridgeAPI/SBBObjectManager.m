...
// SBBBUNDLEID is a preprocessor macro defined in the build settings
...
{
    dispatch_sync(BridgeObjectCacheQueue(), dispatchBlock);
}
...
- (BOOL)resetCache
{
    ...
    dispatchSyncToBridgeObjectCacheQueue(^{
        self.resourcesCachedById = [[NSCache alloc] init];
